...
namespace ArchaeaMod_Debug.NPCs
{
    ...
    {
        public static _GlobalNPC globalNPC;
        public _GlobalNPC()
        {
            globalNPC = this;
        }
        ...
        {
            pool.Add(ModNPCID.Mimic, 0f);
            pool.Add(ModNPCID.Fanatic, 0f);
            pool.Add(ModNPCID.Hatchling, 0f);
            pool.Add(ModNPCID.ItchySlime, 0f);
            pool.Add(ModNPCID.MercurialSlime, 0f);
            pool.Add(ModNPCID.Observer, 0f);
            pool.Add(ModNPCID.Marauder, 0f);
        }
        public override bool CheckActive(NPC npc)
        {
            if (npc.TypeName.Equals("Sky_1"))
                return false;
    ...
    public class NetNPC
    {
        public static void SendExtraAI(BinaryWriter writer)
        {

        }
        public static void RecieveExtraAI(BinaryReader reader)
        {
